    ...
    <div className="app-canvas min-h-screen text-content">
      <div className="max-w-2xl mx-auto px-6 py-12 md:py-16">
        ...
        <header className="mt-8 flex flex-col items-center text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold text-gold-gradient leading-[1.15] pb-0.5">Contact</h1>
        ...
        <div className="surface rounded-2xl p-6 md:p-7 mt-10 text-center">
          <div className="text-xs font-bold tracking-[0.16em] uppercase text-content/45">Email us</div>
          {draft ? (
          ...
          <p className="mt-4 text-sm text-content/50 max-w-[44ch] mx-auto">
            ...
            see the <Link to="/privacy" className="text-content/70 hover:text-content underline underline-offset-2">Privacy Policy</Link>.
          </p>
        </div>
