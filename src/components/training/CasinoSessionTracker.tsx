...
function gradeColor(grade: string): string {
  // Token, not a literal: pure gold on the light theme's white card is about
  // 1.3:1 — the best grade in the app was the least readable thing on it.
  if (grade === 'A+') return 'text-gold'
