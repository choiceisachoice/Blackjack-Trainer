...
export const ALL_ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    id: 'system_scholar',
    name: 'System Scholar',
    description: 'Train with all 6 counting systems (80%+ each)',
    icon: '\uD83D\uDCDA',
    category: 'counting_mastery',
    requirement: { type: 'unique_systems', value: 6 },
    tier: 'gold',
  },
  {
    id: 'counting_grinder',
    name: 'Counting Grinder',
    description: 'Play 5,000 hands in Table Counting',
    icon: '\uD83D\uDD22',
    category: 'counting_mastery',
    requirement: { type: 'hands', value: 5000, mode: 'tableCounting' },
    tier: 'gold',
  },
  {
